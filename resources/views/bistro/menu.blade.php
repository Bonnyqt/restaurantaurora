...
.cover-front:nth-child(1) {
  text-align: center;
  background: linear-gradient(#474747, #474747) 50% 50% / 80% 86% no-repeat, linear-gradient(#ffffff, #ffffff) 50% 50% / 90% 93% no-repeat, linear-gradient(#474747, #474747) no-repeat;
}
...
<div class="book" style="cursor: pointer;">
  <div class="page cover-front" onclick="movePage(this, 1)">
   <br><br>
    <img src="{% static 'images/branding1 .png'%}" style="height: auto;width:360px;"alt="">
    <div class="hat"><i class="fab fa-pied-piper-hat"></i></div>
   
  </div>
  <div class="page cover-front" onclick="movePage(this, 2)"></div>
  <div class="page text-page" style="column-count: 2; column-gap: 40px; text-align: left;"  onclick="movePage(this, 3)">
  <p><strong>FOR THE TABLE</strong></p>
  <p><strong>PAI TEE</strong></p>
  <p style="font-size: 12px;">lump crab, sawtooth coriander, cilantro, mint, basil, tom yum pearls, kaffir powder, fat foam</p>
  <p>390</p>
  <p><strong>CRISPY BETEL LEAVES CUPS</strong></p>
  <p style="font-size: 12px;">scallops, prawns, lemongrass, toasted rice, fried shallots, kaffir lime leaves, nahm jjum, chilles</p>
  <p>390</p>
  
  <p><strong>JAPANESE OYSTERS</strong></p>
  <p style="font-size: 12px;">soft poached, tosazu jelly, pickled cucumbers, szechuan oil</p>
  <p>650</p>
